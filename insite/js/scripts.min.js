...
$(document).ready(function () {
        ...
        function s() {
                if (windowWidth = $(window).width(), a = $(window).height(), t = $(document).height(), windowWidth > 480) $(".overlay").height(a),
                $(".examples").height(t);
                else {
                        $(".wrapper").height(a),
                        $(".overlay, .overlay__case").height(t);
                        var e = -1 * $(window).scrollTop(),
                                s = $(document).scrollTop();
                        $(".overlay__case").data("scrollPosition", e),
                        $(".wrapper__case").css("top", s),
                        $(".overlay").data("scrollPosition", e),
                        $(".wrapper").css("top", s)
                }
        }
        e > 480 && (1366 != a || 1024 != e) && $(window).resize(function () {}),
        $(".case__dialog__button").on("click", function (e) {
                $(".dialog").removeClass("displayNone"),
                $(".case__dialog").removeClass("displayNone"),
                s(),
                $(e.target).hasClass("case__third") ? ($(".case__dialog .offer").text("Продажа душевых кабин RADEWAY"), $(".res-par1").text("Сайт: "), $(".res-par1-2").text("radawashop.by"), $(".res-par2").text("168000 р."), $(".res-par3").text("3052000 р."), $(".res-par4").text("Продать душевые кабины через оффлайн магазин (сайт — radawashop.by)"), $(".res-par5").text("Настройка Я.Д. разработка целевого действия на сайте"), $(".res-par6").text("13,12 р."), $(".res-par7").text("7 р."), $(".res-par8").text("17,7%"), $(".res-par9").text("11,5%"), $(".res-par10").text("1,37 мин."), $(".res11").addClass("displayNone"), $(".res-par12").text("24 000 р."), $(".res-par13").text("продано 134 кабины за 3 летних месяца"), $(".thirdGallery").removeClass("displayNone")) : $(e.target).hasClass("case__first") ? ($(".case__dialog .offer").text("Продажа семян и саженцев через корзину сайта"), $(".res-par1").text("Ниша: "), $(".res-par1-2").text("семена и саженцы в розницу"), $(".res-par2").text("1222986 р."), $(".res-par3").text("32532200 р. "), $(".res-par4").text("Организовать продажи в весенний сезон 2017 г."), $(".res-par5").text("Настройка Яндекс.Директ по ключевым словам"), $(".res-par6").text("5,56 р."), $(".res-par7").text("3,45 р."), $(".res-par8").text("22,69%"), $(".res-par9").text("12,6%"), $(".res-par10").text("4,28 мин."), $(".res11").removeClass("displayNone"), $(".res-par11").text("3,3%"), $(".res-par12").text("600 р."), $(".res-par13").text("5422 заказа с Яндекс.Директа"), $(".firstGallery").removeClass("displayNone")) : $(e.target).hasClass("case__second") && ($(".case__dialog .offer").text("Продажа бензокос Shtenli MS"), $(".res-par1").text("Сайт: "), $(".res-par1-2").text("benzokosi.by"), $(".res-par2").text("63120 р."), $(".res-par3").text("1127520 р. "), $(".res-par4").text("Организовать продажи в летний сезон 2017 г."), $(".res-par5").text("Настройка Яндекс.Директ и Яндекс.Метрики"), $(".res-par6").text("9,11 р."), $(".res-par7").text("2,84 р."), $(".res-par8").text("17,7%"), $(".res-par9").text("12,8%"), $(".res-par10").text("0,48 мин."), $(".res11").removeClass("displayNone"), $(".res-par11").text("1,5%"), $(".res-par12").text("8 500 р."), $(".res-par13").text("173 заказа с Яндекс.Директа"), $(".secondGallery").removeClass("displayNone")),
        ...
        $(".popup").on("click", function (e) {
                s(),
                $(".dialog").removeClass("displayNone"),
                $(e.target).hasClass("person__button") ? ($(".person-modal").addClass("block"), $(".name").attr("type", "text"), $(".name-des").removeClass("displayNone"), $(".email").attr("type", "hidden"), $(".email-des").addClass("displayNone"), $(".dialog .offer").text("Получите консультацию специалиста Insite Studio"), $(e.target).hasClass("ivan") ? $(".person-modal").text("Укажите Ваши данные, и Иван свяжется с Вами в ближайшее время") : $(e.target).hasClass("max") ? $(".person-modal").text("Укажите Ваши данные, и Максим свяжется с Вами в ближайшее время") : $(e.target).hasClass("kir") && $(".person-modal").text("Укажите Ваши данные, и Артур свяжется с Вами в ближайшее время")) : $(e.target).hasClass("cost") ? ($(".dialog .offer").text("Заполните форму, чтобы расчитать стоимость"), $(".person-modal").removeClass("block")) : $(e.target).hasClass("call__button") && ($(".dialog .offer").text("Заказать обратный звонок"), $(".overlay").addClass("call_overlay"), $(".email").attr("type", "hidden"), $(".email-des").addClass("displayNone"), $(".person-modal").addClass("block"), $(".person-modal").text("Заполните форму, и мы свяжемся с Вами в ближайшее время и ответим на все интересующие Вас вопросы")),
                $(".overlay").addClass("visible")
        }),

        $(window).on("focusin", "input", function (e) {
                $("input").focus()
        }),
        $(".open__example").on("click", function (a) {
                var r = $(a.target);
                r.is(".open__example") || (r = r.parents(".open__example"), console.log(r)),
                s(),
                e > 480 ? ($(".example-wrapper").css("top", $(document).scrollTop() + 20), r.hasClass("xpom") && $(".examples").height(1.85 * t)) : ($(".example-wrapper").css("top", $(document).scrollTop()), r.hasClass("xpom") && $(".examples").height(1.14 * t)),
                $(".examples").height(t),
                $(".examples img").removeAttr("src"),
                $(".examples img").attr("src", r.attr("data-src")),
                $(".examples").addClass("visible")
        }),
        $(".close").on("click", function () {
                $(".overlay__case").hasClass("visible") ? ($("body").find(".overlay__case").removeClass("visible"), $(".firstGallery").addClass("displayNone"), $(".secondGallery").addClass("displayNone"), $(".thirdGallery").addClass("displayNone")) : ($("body").find(".overlay").removeClass("visible"), $(".name").attr("type", "hidden"), $(".name-des").addClass("displayNone")),
        ...
        $(".overlay").on("click", function (e) {
                var a = $(e.target);
                a.is(".dialog, .thankyou") || a.parents().is(".dialog, .thankyou") || ($(".overlay").removeClass("visible"), $(".overlay").removeClass("call__overlay"), $(".name").attr("type", "hidden"), $(".name-des").addClass("displayNone"), $(".email").attr("type", "email"), $(".email-des").removeClass("displayNone"), $(".thankyou").addClass("displayNone"))
        }),
        $(".overlay__case").on("click", function (e) {
                var a = $(e.target);
                a.is(".case__dialog, .dialog, .thankyou") || a.parents().is(".case__dialog, .dialog, .thankyou") || ($(".overlay__case").removeClass("visible"), $(".firstGallery").addClass("displayNone"), $(".secondGallery").addClass("displayNone"), $(".thirdGallery").addClass("displayNone"), $(".thankyou").addClass("displayNone"))
        }),
        $(".examples").on("click", function (e) {
                $(e.target).is(".examples img") || $(".examples").removeClass("visible")
        }),
         $("#fourth__callback").submit(function () {
                var e = $(this);
                return $.ajax({
                        type: "POST",
                        url: "../mail.php",
                        ...
                        $(".case__dialog").addClass("displayNone"),
        ...
        $("#third__callback").submit(function () {
                var e = $(this);
                return $.ajax({
                        type: "POST",
                        url: "../mail.php",
        ...
        $("#first__callback").submit(function () {
                var e = $(this);
                return $.ajax({
                        type: "POST",
                        url: "../mail1.php",
                        ...
                        window.history.pushState("Thank you!", "insite | studio", "/thanks"),
                        $(".recom2").removeClass("displayNone"),
                        setTimeout(function () {
                                e.trigger("reset")
                        }, 1e3)
                }),
        ...
        $('#second__callback').submit(function(e) { 
                var form = $(this);
                $.ajax({
          type: "POST",
          url: "../mail.php",
          data: form.serialize()
                }).done(function() {   //Далее находится часть кода, которая отвечает за появление страницы благодарности
                        $('.recom1').removeClass('displayNone');
                        $(this).find('input').val('');
                        $(this).trigger('reset');
                });
                e.preventDefault();
        ...
        $(".button__case").on("click", function () {
                var a = .025 * e,
                        t = 650;
                e < 480 && (a = .075 * e, t = 1e3);
                var s = $(".screen__fourth").offset().top + a;
        ...
        function (e) {
                for (var a = function (e) {
                        ...
                        if (a) {
                                for (var s, r = a.parentNode, l = a.parentNode.childNodes, o = l.length, i = 0, n = 0; n < o; n++) if (1 === l[n].nodeType) {
                                        if (l[n] === a) {
                                                s = i;
                                                break
                                        }
                        ...
                        var r, l, o = document.querySelectorAll(".pswp")[0];
                        if (l = function (e) {
                                for (var a, t, s, r, l = e.childNodes, o = l.length, i = [], n = 0; n < o; n++) 1 === (a = l[n]).nodeType && (s = (t = a.children[0]).getAttribute("data-size").split("x"), r = {
                                        src: t.getAttribute("href"),
                                        w: parseInt(s[0], 10),
                                        h: parseInt(s[1], 10)
                                }, a.children.length > 1 && (r.title = a.children[1].innerHTML), t.children.length > 0 && (r.msrc = t.children[0].getAttribute("src")), r.el = a, i.push(r));
                                return i
                        }(a), r = {
                                zoomEl: !0,
                                tapToClose: !1,
                                ...
                                getThumbBoundsFn: function (e) {
                                        var a = l[e].el.getElementsByTagName("img")[0],
                                ...
                                for (var i = 0; i < l.length; i++) if (l[i].pid == e) {
                                        r.index = i;
                                        break
                                }
                        } else r.index = parseInt(e, 10) - 1;
                        else r.index = parseInt(e, 10);
                        isNaN(r.index) || (t && (r.showAnimationDuration = 0), new PhotoSwipe(o, PhotoSwipeUI_Default, l, r).init())
                }, s = document.querySelectorAll(e), r = 0, l = s.length; r < l; r++) s[r].setAttribute("data-pswp-uid", r + 1),
                s[r].onclick = a;
                var o = function () {
                        var e = window.location.hash.substring(1),
                                a = {};
                        if (e.length < 5) return a;
                        for (var t = e.split("&"), s = 0; s < t.length; s++) if (t[s]) {
                                var r = t[s].split("=");
                                r.length < 2 || (a[r[0]] = r[1])
                        }
                        return a.gid && (a.gid = parseInt(a.gid, 10)),
                        a
                }();
                o.pid && o.gid && t(o.pid, s[o.gid - 1], !0, !0)
        }(".gallery")
});